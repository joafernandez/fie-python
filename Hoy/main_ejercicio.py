...
from strategy_formacion import formacion_l,formacion_v,formacion_w
def main():
    # (1) Bandada en V con especies pedidas
    try:
        g1 = Gaviota("20")
    except ValueError as e:
        print(f"Error al crear la Gaviota ==> {e}")    
    g1 = Gaviota(20)
    g2 = Gaviota(10)
    ...
    #CREAR TEST DE LAS SIGUIENTES SITUACIONES:
    ...
    b1.cambiar_formacion(formacion_l())
    b1.ensuciar(auto)
    print(auto)
